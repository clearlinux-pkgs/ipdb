...
Source0  : https://files.pythonhosted.org/packages/2c/bb/a3e1a441719ebd75c6dac8170d3ddba884b7ee8a5c0f9aefa7297386627a/ipdb-0.13.2.tar.gz
...
%prep
%setup -q -n ipdb-0.13.2
cd %{_builddir}/ipdb-0.13.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583248355
...
cp %{_builddir}/ipdb-0.13.2/COPYING.txt %{buildroot}/usr/share/package-licenses/ipdb/eac15b69f9f0a12e02459ba5c6be4fa52c10f364
