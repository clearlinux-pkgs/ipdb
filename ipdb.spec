...
%prep
%setup -q -n ipdb-0.13.4
cd %{_builddir}/ipdb-0.13.4
...
cp %{_builddir}/ipdb-0.13.4/COPYING.txt %{buildroot}/usr/share/package-licenses/ipdb/eac15b69f9f0a12e02459ba5c6be4fa52c10f364
