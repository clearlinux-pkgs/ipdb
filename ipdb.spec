...
Source0  : https://files.pythonhosted.org/packages/20/b7/d32c6a1706f58779db553ff78f59cd3fc3a627d87901b80cd67a4f264a89/ipdb-0.13.5.tar.gz
...
%prep
%setup -q -n ipdb-0.13.5
cd %{_builddir}/ipdb-0.13.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614699579
...
cp %{_builddir}/ipdb-0.13.5/COPYING.txt %{buildroot}/usr/share/package-licenses/ipdb/eac15b69f9f0a12e02459ba5c6be4fa52c10f364
