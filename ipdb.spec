...
Version  : 0.13.1
Release  : 14
URL      : https://files.pythonhosted.org/packages/d2/c9/f77ba78c31d9d7133434b2bd74325bb301aa0cd3490bb67cfae20d1c3db2/ipdb-0.13.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d2/c9/f77ba78c31d9d7133434b2bd74325bb301aa0cd3490bb67cfae20d1c3db2/ipdb-0.13.1.tar.gz
...
%prep
%setup -q -n ipdb-0.13.1
cd %{_builddir}/ipdb-0.13.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583160201
...
cp %{_builddir}/ipdb-0.13.1/COPYING.txt %{buildroot}/usr/share/package-licenses/ipdb/eac15b69f9f0a12e02459ba5c6be4fa52c10f364
